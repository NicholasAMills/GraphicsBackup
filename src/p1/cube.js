...
class Cube {
    ...
    constructor(gl) {
        ...
        // TODO The cube is defined to be 1 unit in size with one corner on the origin
        ...
        this.world = this.world.translate(-0.25, -0.25, -0.25);
    ...
    render(gl, projection) {
        ...
        gl.bindBuffer(gl.ARRAY_BUFFER, this.colorsBuffer);
        let colBuf = gl.getAttribLocation(this.program, "cubeColor");
        gl.vertexAttribPointer(colBuf, 4, gl.FLOAT, false, 0, 0);
        gl.enableVertexAttribArray(colBuf);
        ...
        // TODO bind this.getModel (get its data as an array) to the matModel uniform (it is a matrix)
        ...
        gl.bindBuffer(gl.ARRAY_BUFFER, this.edgeColorsBuffer);
        let edg = gl.getAttribLocation(this.program, "cubeColor");
        gl.vertexAttribPointer(edg, 4, gl.FLOAT, false, 0, 0);
        gl.enableVertexAttribArray(edg);
    ...
    rotate(xtheta, ytheta, ztheta) {
        ...
        this.rotateMatrix = this.translateMatrix.rotate(xtheta, ytheta, ztheta);
    }
