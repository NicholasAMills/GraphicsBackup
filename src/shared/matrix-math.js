...
class Camera {
    ...
    /**
     * creating orthographic projection
     * @param {number} left
     * @param {number} right
     * @param {number} bottom
     * @param {number} top
    ...
    /**
     * creating perspective projection
     * @param {number} left
     * @param {number} right
     * @param {number} bottom
     * @param {number} top
     ...
     * @param {Vector} lookedAt location being looked at
     * @param {Vector} upVector camera orientation
     */
    lookAt(eyeLocation, lookedAt, upVector) {
        let n = eyeLocation.subtract(lookedAt).normalize();
        let u = upVector.crossProduct(n).normalize();
        let v = n.crossProduct(u).normalize();
        console.log("n: " + n.getData());
        console.log("u: " + u.getData());
        console.log("v: " + v.getData());
        ...
        look = look.translate(-eyeLocation.getX(), -eyeLocation.getY(), -eyeLocation.getZ());

        // console.log(look.getData());
        this.camView = look;
        return look;
    }
    ...
    /**
     *
     * @param {Vector} camLocation camera location
     * @param {Vector} viewNormVec where camera is facing
     * @param {Vector} upVec orientation of camera
     */
    viewPoint(camLocation, viewNormVec, upVec) {
        let n = new Vector();
        let u = new Vector();
        let v = new Vector();

        n = camLocation.subtract(viewNormVec);
        u = upVec.crossProduct(n);
        v = n.crossProduct(u);
        ...
        let look = new Matrix([
            u.getX(), u.getY(), u.getZ(), -camLocation.getX() * u.getX() - camLocation.getY() * u.getY() - camLocation.getZ() * u.getZ(),
            v.getX(), v.getY(), v.getZ(), -camLocation.getX() * v.getX() - camLocation.getY() * v.getY() - camLocation.getZ() * v.getZ(),
            n.getX(), n.getY(), n.getZ(), -camLocation.getX() * n.getX() - camLocation.getY() * n.getY() - camLocation.getZ() * n.getZ(),
            0, 0, 0, 1
        ]);
