...
class Sphere extends Shape {
    ...
    constructor(numTimesToSubdivide) {
        ...
        for (let divisionNumber = 1; divisionNumber < numTimesToSubdivide; divisionNumber++) {
            let newVertices = [];
            for (let i = 0; i < vertices.length; i += 9) { // loop thruogh all triangles/vertices.
            ...
            vertices = newVertices; // set new vertices
        }
        ...
        /**
         * Finds the midpoint between vertex A and B
         * @param {Vector} A
         * @param {Vector} B
         * @returns {Vector}
         */
